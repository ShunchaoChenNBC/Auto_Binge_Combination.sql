...
and DATE(timestamp(post_cust_hit_time_gmt), "America/New_York") between "2022-10-05" and "2022-11-25"),
...
and adobe_date  between "2022-10-05" and "2022-11-25"
...
select *
from click_Ready
where lower(Feeder_Video) =  "a friend of the family" 
union all
select *
from cte1
where lower(Feeder_Video) =  "a friend of the family" 
